...
def insert(cfg, sess, img_path, file_path):
    ...
    batches_out = sess.run('alice_vars_1/alice_eval_out:0', feed_dict={
...
def main():
    ...
    model_dir = os.path.join(target_dir, "trained_models")
    model_path = os.path.join(model_dir, "StegoNet.cpkt")
